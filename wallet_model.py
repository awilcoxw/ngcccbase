...
class ColorSet(object):
    ...
    def get_genesis_txhashes(self):
        """Returns a list of strings that correspond to the transactions
        where this color originated.
        e.g. ["f0db5...a5", "c732a...09"]
        """
        return [desc.split(":")[1] for desc in self.color_desc_list]
...
class ColoredCoinContext(object):
    ...
    def __init__(self, config):
        ...
        cdbuilder = builder.ColorDataBuilderManager(
            ...
            self.metastore, builder.AidedColorDataBuilder)
