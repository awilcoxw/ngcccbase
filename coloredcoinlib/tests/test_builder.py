...
from coloredcoinlib.builder import ColorDataBuilderManager, FullScanColorDataBuilder
from coloredcoinlib.colordata import ThickColorData
...
class TestBuilder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.store_conn = DataStoreConnection("test-color.db")
